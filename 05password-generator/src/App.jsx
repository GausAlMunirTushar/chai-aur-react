...
function App() {
	...
	return (
		<>
			<div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 mx-1text-orange-600 bg-gray-700">
			<h1 className="text-4xl text-center text-white my-4">
				...
				<div className="flex text-sm gap-x-2 text-green-700">
